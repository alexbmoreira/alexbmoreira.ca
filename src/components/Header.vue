  ...
  <div class="relative flex bg-opacity-0 bg-space bg-cover h-screen">
    <div class="text-white flex flex-col m-auto space-y-6">
      ...
      <div class="mx-auto text-4xl justify-around flex w-9/12 md:text-3xl">
        <a href="https://github.com/alexbmoreira" class="text-center transition duration-400 ease-in-out hover:text-blue-600">
          <i class="fab fa-github"></i>
          <p class="text-xs">Github</p>
        </a>
        <a href="https://www.linkedin.com/in/alexbmoreira" class="text-center transition duration-400 ease-in-out hover:text-blue-600">
          <i class="fab fa-linkedin"></i>
          <p class="text-xs">LinkedIn</p>
        </a>
        <a href="" class="text-center transition duration-400 ease-in-out hover:text-blue-600">
